...
export default function Comparision(props) {
  ...
  return (
   <div className="p-32 w-full flex flex-row items-center justify-between py-40">
      <div className="w-1/2">

      <ImageComparisonSlider beforeSrc={beforeSrc} afterSrc={afterSrc}/>
      </div>
      <div className="w-1/2 h-full flex flex-col items-start justify-center max-w-[510px] ">
