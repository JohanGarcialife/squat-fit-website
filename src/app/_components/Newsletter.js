...
export default function Newsletter() {
  return (
    <div className='bg-secondary flex flex-col items-center justify-center py-40'>
        <h2 className='font-bold text-white text-6xl lg:max-w-[1000px] w-full text-center'>Suscríbete a nuestra newsletter para recibir ofertas y noticias</h2>
        <div className='mt-10 flex w-full px-5 flex-col lg:flex-row gap-5 lg:max-w-[710px] items-center justify-between'>
