                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <button
                            ...
                            aria-label="Anterior"
                            className="cursor-pointer absolute top-1/2 left-0 sm:left-[-10px] -translate-y-1/2 z-20 bg-[#FFEDE0] text-[#FF690B] rounded-full p-2 shadow-md hover:scale-110 active:scale-95 transition-transform duration-200"
                        >
                        ...
                        <button
                            ...
                            className="cursor-pointer absolute top-1/2 right-0 sm:right-[-10px] -translate-y-1/2 z-20 bg-[#FFEDE0] text-[#FF690B] rounded-full p-2 shadow-md hover:scale-110 active:scale-95 transition-transform duration-200"
                        >
