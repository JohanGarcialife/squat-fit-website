...
const ContenidoAvisoLegal = () => {
  return (
    <div className="animate-fadeIn">
      ...
      <p className="mb-4">
        Squad Fit será titular de todos los derechos de propiedad intelectual e industrial del portal web/app, así como de los elementos contenidos en la misma (a título enunciativo, imágenes, sonido, audio, vídeo, software o textos; marcas o logotipos, combinaciones de colores, estructura y diseño, selección de materiales usados, programas de ordenador necesarios para su funcionamiento, acceso y uso, etc.).
      </p>
      <p className="mb-8">
        Todos los derechos reservados. En virtud de lo dispuesto en los artículos 8 y 32.1, párrafo segundo, de la Ley de Propiedad Intelectual, quedan expresamente prohibidas la reproducción, la distribución y la comunicación pública, incluida su modalidad de puesta a disposición, de la totalidad o parte de los contenidos de esta web/app, con fines comerciales, en cualquier soporte y por cualquier medio técnico, sin la autorización de Squad Fit. El USUARIO se compromete a respetar los derechos de Propiedad Intelectual e Industrial titularidad de Squad Fit. Podrá visualizar los elementos del portal e incluso imprimirlos, copiarlos y almacenarlos en el disco duro de su ordenador o en cualquier otro soporte físico siempre y cuando sea, única y exclusivamente, para su uso personal y privado. El USUARIO deberá abstenerse de suprimir, alterar, eludir o manipular cualquier dispositivo de protección o sistema de seguridad en el que estuviera instalado las páginas del portal web/app móvil Squad Fit.
      </p>

      <h2 className="text-xl font-bold text-black mb-3">Exclusión de garantías y responsabilidad</h2>
      <p className="mb-8">
        Squad Fit no se hace responsable, en ningún caso, de los daños y perjuicios de cualquier naturaleza que pudieran ocasionar, a título enunciativo: errores u omisiones en los contenidos, falta de disponibilidad del portal o la transmisión de virus o programas maliciosos o lesivos en los contenidos, a pesar de haber adoptado todas las medidas tecnológicas necesarias para evitarlo.
      </p>
      ...
      <p className="mb-8">
        Squad Fit se reserva el derecho a denegar o retirar el acceso al portal y/o los servicios ofrecidos sin necesidad de preaviso, a instancia propia o de un tercero, a aquellos usuarios que incumplan las presentes Condiciones Generales de Uso.
      </p>

      <h2 className="text-xl font-bold text-black mb-3">Generalidades</h2>
      <p className="mb-8">
        Squad Fit perseguirá el incumplimiento de las presentes condiciones, así como cualquier utilización indebida de su portal ejerciendo todas las acciones civiles y penales que le puedan corresponder en derecho.
      </p>

      <h2 className="text-xl font-bold text-black mb-3">Modificación de las presentes condiciones y duración</h2>
      <p className="mb-8">
        Squad Fit podrá modificar en cualquier momento las condiciones aquí determinadas, siendo debidamente publicadas como aquí aparecen.<br />
      ...
      <p>
        La relación entre Squad Fit y el USUARIO se regirá por la normativa española vigente y cualquier controversia se someterá a los Juzgados y tribunales de la ciudad anteriormente indicada.
      </p>
    </div>
  );
};
...
const ContenidoCookies = () => (
  <div className="animate-fadeIn">
    ...
    <p>Squad Fit puede utilizar servicios de terceros (como Google Analytics) para fines estadísticos. Puede consultar las políticas de privacidad de dichos proveedores en sus sitios web respectivos.</p>
  </div>
);
...
const ContenidoTerminos = () => (
  <div className="animate-fadeIn">
    ...
    <p className="mb-6">Los precios incluyen los impuestos aplicables. Squad Fit puede modificar sus tarifas, notificando al usuario con antelación razonable.</p>
    <h2 className="text-xl font-bold text-black mb-3">4. Uso adecuado</h2>
    <p className="mb-6">Queda prohibida la reproducción o distribución de los contenidos sin autorización expresa de Squad Fit.</p>
    <h2 className="text-xl font-bold text-black mb-3">5. Responsabilidad</h2>
    <p className="mb-6">Los planes de nutrición y entrenamiento son orientativos y no sustituyen el consejo médico. Squad Fit no se responsabiliza de los resultados individuales de cada usuario.</p>
