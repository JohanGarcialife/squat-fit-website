...
const VARIANTS = {
  orange: {
    ...
    sweep: 'bg-gradient-to-r from-transparent via-[#FFEDE0]/80 to-transparent',
  },
  'orange-light': {
    button: 'bg-[#FFEDE0] text-[#FF690B] hover:bg-[#FF690B] hover:text-white hover:shadow-[#FF690B]/30',
    sweep: 'bg-gradient-to-r from-transparent via-[#FF690B]/55 to-transparent',
  },
  blue: {
    button: 'bg-[#363C98] text-white hover:bg-[#E7E6FF] hover:text-[#363C98] hover:shadow-[#363C98]/30',
    sweep: 'bg-gradient-to-r from-transparent via-[#E7E6FF]/80 to-transparent',
  },
  'blue-light': {
