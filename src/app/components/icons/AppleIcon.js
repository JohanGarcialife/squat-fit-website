// src/app/components/icons/AppleIcon.js
// Compartido entre el Sidebar del panel ("Mi cocina") y el tour de
// bienvenida (AppTour): mismo SVG en los dos.
export default function AppleIcon({ filled, width = 30, height = 30 }) {
  return (
