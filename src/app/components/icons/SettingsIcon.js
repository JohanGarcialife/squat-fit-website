// src/app/components/icons/SettingsIcon.js
// Compartido entre el Sidebar del panel ("Ajustes") y el tour de
// bienvenida (AppTour): mismo SVG en los dos.
export default function SettingsIcon({ filled, width = 30, height = 30 }) {
  return (
